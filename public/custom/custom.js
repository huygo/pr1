const callAjax = async (url, dataPost, typeData, method, csrfToken, check_loading)=>{
    ...
    let html_spiner = '<div class="modal fade" id="loading_spinner" data-backdrop="static" data-keyboard="false">\
...
function notifyModel(option = false, context = ''){
    ...
    <div class="modal-dialog modal-dialog-centered">\
      <div class="modal-content">\
        <div class="modal-header" style="justify-content: center;background-color: #28a745;">\
